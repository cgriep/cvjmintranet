{* Template Adresskategorien bearbeiten *}
<table width="100%">
{assign var="i" value="0"}
{foreach from=$Adresse->getKategorien(true) item=Kategorie}
  {if $i%2==0}
  ...
  <td>
    <input type="Checkbox" name="docinput[Kategorien][]" 
      ...
      onClick="xajax_setzeAdressKategorie({$Adresse->Adressen_id},{$Kategorie.Kategorie_id},this.checked)"      
      />
  </td>
  <td>
